        ...
        {/* Rating */}
        {
          ...
          (
            ...
            <div className="appreciation">
              ...
              <div className="appreciatiotext">
                <h1>Thank you!</h1>
                <p>We appreciate you taking the time to give the rating.</p>
                <p>if you ever need more support, don't hesitate <br/> to get in touch!</p>
              </div>
            </div>
          )
        }
